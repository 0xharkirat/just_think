...
final goRouter = Provider<GoRouter>((ref) {
  final blockedApp = ref.watch(blockedAppStateProvider);
...
/// StateProvider to track the current blocked app's package name
final blockedAppStateProvider = StateProvider<String?>((ref) => null);
